...
namespace Graphite {
	Graphite::Shader::Shader(const std::string& vertexSrc, const std::string& fragmentSrc)
	{
	...
	Graphite::Shader::~Shader()
	{
		glDeleteProgram(m_RendererID);
	}

	void Graphite::Shader::Bind() const
	{
		glUseProgram(m_RendererID);
	}

	void Graphite::Shader::Unbind() const
	{
		glUseProgram(0);
	}
}